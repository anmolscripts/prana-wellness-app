...
<!-- / Content -->
    ...
    <!-- Vendors JS -->
    <script src="../public/assets/vendor/libs/cleave-zen/cleave-zen.js"></script>
  ...
  <script src="../public/assets/js/pages-auth-two-steps.js"></script>
