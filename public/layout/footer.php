    ...
    <div class="modal-dialog modal-dialog-centered modal-lg " role="document">
        <div class="modal-content">
            <div class="modal-header pt-0 z-5">
                ...
                <button type="button" class="btn-close bg-dark text-white" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <div class="modal-body p-0">
                <div class="card h-100 position-relative rounded-3 overflow-hidden">
                    <img class="card-img-top"
                        src="/prana-wellness-app/public/uploads/layout/1747725753_682c2db92d461_person-practicing-yoga-meditation-nature-sunset-sunrise (1).jpg"
                        alt="Card image cap">
