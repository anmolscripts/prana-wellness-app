<?php session_start();
$admin = $_SESSION['user']['permission'] == 'admin' ? 'admin' : 'user';
...
<body>
    <script>
        console.log(<?= json_encode($publicPath) ?>);
    </script>
        ...
        <div class="layout-container">
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    <li class="menu-item active" data-aside="<?= $admin ? 'admin/' : '' ?>dashboard"><a href="<?= $admin ? 'admin/' : '' ?>dashboard" class="menu-link"><i
                    ...
                    <?php if ($admin) : ?>
                        <li class="menu-item" data-aside="<?= $admin ? 'admin/' : '' ?>activities"><a href="<?= $admin ? 'admin/' : '' ?>activities" class="menu-link"><i
                    ...
                    <li class="menu-item" data-aside="<?= $admin ? 'admin/' : '' ?>account,<?= $admin ? 'admin/' : '' ?>notification"><a href="javascript:void(0);" class="menu-link menu-toggle"><i
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item" data-aside="<?= $admin ? 'admin/' : '' ?>account"><a href="<?= $admin ? 'admin/' : '' ?>account" class="menu-link">
                                    <div class="text-truncate" data-i18n="Account">Account</div>
                                </a></li>
                            <li class="menu-item" data-aside="<?= $admin ? 'admin/' : '' ?>notification"><a href="<?= $admin ? 'admin/' : '' ?>notification" class="menu-link">
